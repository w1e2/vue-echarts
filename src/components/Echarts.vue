    ...
    <div style="width: 100%;">
		...
		<div style="width:80%; margin-left:11%; margin-bottom: 50px;">
			...
			<div class="table">
				...
				<div style="width: 40%;">
					<div id="main4" style="width: 100%; height: 330px;"></div>
				</div>
			</div>
		</div>
    </div>
...
export default {
  ...
  methods: {
    drawLine(){
        let myChartq1 = this.$echarts.init(document.getElementById('main1'));
        let option1 = {
            title: {
                text: '1、当日24小时流量趋势图',
                textStyle: {
        ...
        // 使用刚指定的配置项和数据显示图表。
        myChartq1.setOption(option1);
	
	    let myChartq2 = this.$echarts.init(document.getElementById('main2'));
	    let index = 0;
        ...
        // 使用刚指定的配置项和数据显示图表。
        myChartq2.setOption(option2);
	
	    let myChartq3 = this.$echarts.init(document.getElementById('main3'));
        let option3 = {
            title: {
	    ...
	    let myChartq4 = this.$echarts.init(document.getElementById('main4'));
        let option4 = {
